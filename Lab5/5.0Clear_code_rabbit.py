...
def draw_ear(Coordin_x, Coordin_y, length, thickness, colour_ear, colour_inner):
    ...
    ellipse(screen, colour_ear, (Coordin_x - thickness//2, Coordin_y - length, 
                                 thickness, length))
    ellipse(screen, colour_inner, (Coordin_x - thickness//4, Coordin_y - 2*length//3,
...
def rabbit(Coordin_x, Coordin_y, height, length_ears, colour_0, colour_1):
    ...
    draw_ear(Coordin_x - int(0.1*height), Coordin_y - int(0.85*height), length_ears,
             int(0.35*length_ears), colour_0, colour_1)
    draw_leg(Coordin_x + int(0.1*height), Coordin_y - int(0.02*height), 
             int(0.1*height), int(0.25*height), colour_0)
    draw_leg(Coordin_x - int(0.35*height), Coordin_y - int(0.02*height), 
             int(0.1*height), int(0.25*height), colour_0)
